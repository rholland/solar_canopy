...
Client
Date
Location image:: c:\git\solar_canopy\rivtManual\solar-canopy-2023\resource\rv01-loads\fig1.png
   :width:  35 

..  image:: c:\git\solar_canopy\rivtManual\solar-canopy-2023\resource\rv01-loads\fig2.png
   :width:  35 
**Site map - Marin County web site ** ?x?hfill [02] Fig. 02 - 2**Site map - Google Earth ** ?x?hfill [02] Fig. 04 - 2.. raw:: latex
...
.. raw:: latex 
 ...
 ?x?newpage 
**[03] Table: 02** ?x?hfill  [03] Table: 02==========  =======  =========  =================================
...
==========  =======  =========  =================================**[03] Table: 04** ?x?hfill  [03] Table: 04==========  ========  =========  ==========================
variable       value    [value]  description
==========  ========  =========  ==========================
...
==========  ========  =========  ==========================**[03] Table: 06** ?x?hfill  [03] Table: 06==========  =======  =========  =============================
variable      value    [value]  description
==========  =======  =========  =============================
...
==========  =======  =========  =============================**[03] Table: 08** ?x?hfill  [03] Table: 08==========  =======  =========  =============================
variable      value    [value]  description
==========  =======  =========  =============================
...
==========  =======  =========  =============================**[03] Table: 10** ?x?hfill  [03] Table: 10**Roof weight ** ?x?hfill [03] Equ. 02**rfwt1 = arearf1 * roofdl1                           ** ?x?hfill [03] Equ. 03
**Floor weight ** ?x?hfill [03] Equ. 05**flrwt1 = areaflr1 * floordl1                        ** ?x?hfill [03] Equ. 06
**Partition weight ** ?x?hfill [03] Equ. 08**partwt1 =  htwall1 * lenwall1 * intwalldl1          ** ?x?hfill [03] Equ. 09
**Exterior wall weight ** ?x?hfill [03] Equ. 11**exwallwt1 = htwall1 * lenwall2 * extwalldl1         ** ?x?hfill [03] Equ. 12
**Total building weight ** ?x?hfill [03] Equ. 14**totwt1 = rfwt1 + flrwt1 + partwt1 + exwallwt1       ** ?x?hfill [03] Equ. 15
**[03] Table: 12** ?x?hfill  [03] Table: 12**Effective model floor load  ** ?x?hfill [04] Equ. 17**eflrdl1 = (flrwt1 + partwt1)/(areaflr1)                     ** ?x?hfill [04] Equ. 18
**Effective model floor density ** ?x?hfill [04] Equ. 20**eflrdens1 = eflrdl1/(0.5*IN)                                ** ?x?hfill [04] Equ. 21
**Effective model roof density ** ?x?hfill [04] Equ. 23**erfdens1 = roofdl1/(1.5*IN)                                 ** ?x?hfill [04] Equ. 24
**Effective model wall density ** ?x?hfill [04] Equ. 26**ewalldens1 = extwalldl1/(0.5*IN)                            ** ?x?hfill [04] Equ. 27
**[04] Table: 14** ?x?hfill  [04] Table: 14.. raw:: latex 
...
.. raw:: latex 
 ...
 ?x?newpage 
?x?begin{center} Abbreviations - Terms ?x?end{center}.. raw:: latex
...
?x?begin{center} Abbreviations - Math ?x?end{center}.. raw:: latex
