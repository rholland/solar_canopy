...
fname1 = C:\Dropbox\_loring\model\etab\remod28
fname2 = %fname1%.eig
fname3 = %fname1%.dsp
fname4 = %fname1%.ekb
fname5 = %fname1%.eko
...
Loop, 20 {
    ...
    if !WinExist("etabsn") {
        ...
        sleep, 500
        Run sed -i "s/\x0C//;/PROGRAM:ETABS/d;/PAGE/d;/^[[:space:]]*$/d;/^$/d" %fname7%
        sleep, 500
        FileDelete, sed* 
        sleep, 500
        Run, c:\etabsn\etabsout.exe
        sleep, 1000
        send !F
        sleep, 1000
        send O
        ...
        send x
        sleep, 1000
        Run, vs.exe %fname2% %fname3% %fname4% %fname6% %fname7%
        sleep, 1000
        Run, _rot1.ahk
        ExitApp
        }       
