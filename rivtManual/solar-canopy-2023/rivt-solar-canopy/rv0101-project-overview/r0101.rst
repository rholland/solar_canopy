...
** Table: 02 [03]** ?x?hfill   Table: 02 [03]
==========  =======  =========  =================================
...
==========  =======  =========  =================================
** Table: 04 [03]** ?x?hfill   Table: 04 [03]
==========  ========  =========  ==========================
variable       value    [value]  description
==========  ========  =========  ==========================
...
==========  ========  =========  ==========================
** Table: 06 [03]** ?x?hfill   Table: 06 [03]
==========  =======  =========  =============================
variable      value    [value]  description
==========  =======  =========  =============================
...
==========  =======  =========  =============================
** Table: 08 [03]** ?x?hfill   Table: 08 [03]
==========  =======  =========  =============================
variable      value    [value]  description
==========  =======  =========  =============================
...
==========  =======  =========  =============================
** Table: 10 [03]** ?x?hfill   Table: 10 [03]

**Roof weight** ?x?hfill  Equ. 02 [03]

**rfwt1 = arearf1 * roofdl1** ?x?hfill  Equ. 03 [03]

**Floor weight** ?x?hfill  Equ. 05 [03]

**flrwt1 = areaflr1 * floordl1** ?x?hfill  Equ. 06 [03]

**Partition weight** ?x?hfill  Equ. 08 [03]

**partwt1 =  htwall1 * lenwall1 * intwalldl1** ?x?hfill  Equ. 09 [03]

**Exterior wall weight** ?x?hfill  Equ. 11 [03]

**exwallwt1 = htwall1 * lenwall2 * extwalldl1** ?x?hfill  Equ. 12 [03]

**Total building weight** ?x?hfill  Equ. 14 [03]

**totwt1 = rfwt1 + flrwt1 + partwt1 + exwallwt1** ?x?hfill  Equ. 15 [03]

** Table: 12 [03]** ?x?hfill   Table: 12 [03]
...
**Effective model floor load** ?x?hfill  Equ. 17 [04]

**eflrdl1 = (flrwt1 + partwt1)/(areaflr1)** ?x?hfill  Equ. 18 [04]

**Effective model floor density** ?x?hfill  Equ. 20 [04]

**eflrdens1 = eflrdl1/(0.5*IN)** ?x?hfill  Equ. 21 [04]

**Effective model roof density** ?x?hfill  Equ. 23 [04]

**erfdens1 = roofdl1/(1.5*IN)** ?x?hfill  Equ. 24 [04]

**Effective model wall density** ?x?hfill  Equ. 26 [04]

**ewalldens1 = extwalldl1/(0.5*IN)** ?x?hfill  Equ. 27 [04]

** Table: 14 [04]** ?x?hfill   Table: 14 [04]
.. raw:: latex 
